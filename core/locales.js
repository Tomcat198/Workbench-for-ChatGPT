...
const I18N_MESSAGES = {
  en: {
    ...
    "prompt.itemMetaWithTime": "{category} · {time} · Click to insert",
    "prompt.itemMetaNoTime": "{category} · Click to insert",
  ...
  "zh-CN": {
    ...
    "prompt.delete": "删除",
    "prompt.itemMetaWithTime": "{category} · {time} · 单击插入",
    "prompt.itemMetaNoTime": "{category} · 单击插入",
