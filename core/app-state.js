...
const state = {
  ...
  anchorNode: null,
  anchorParent: null,
  // Primary collapse state (group-first semantics).
  collapsedGroupKeys: [],
  // Derived compatibility cache from collapsedGroupKeys.
  collapsedTurnKeys: [],
  // Derived compatibility cache from collapsedGroupKeys.
